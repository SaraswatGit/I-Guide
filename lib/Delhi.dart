...
class Delhi extends StatelessWidget
{
  ...
  Widget build(BuildContext context)
  {
    ...
    return  Scaffold(backgroundColor: Colors.grey,
      appBar: AppBar(title: Text('DELHI'),backgroundColor: Colors.teal,centerTitle: true,),
            ...
            Card(
              child: Container(
                ...
                child:InkWell(
                  ...
                  onTap: () {
                    Navigator.push(context,MaterialPageRoute(builder: (context)=>delhiknow()));
                  },
                  child: Container(
                    width: 500,
                    height: 170,
            ...
            Card(
              child: Container(
                ...
                child:InkWell(
                  splashColor: Colors.grey.withAlpha(30),
                  onTap: () {
                    Navigator.push(context,MaterialPageRoute(builder: (context)=> checklistdel()));
                  },
                  child: Container(
                    width: 500,
                    height: 170,
            ...
            Card(
              child: Container(
                ...
                child:InkWell(
                  splashColor: Colors.grey.withAlpha(30),
                  onTap: () {
                    Navigator.push(context,MaterialPageRoute(builder: (context)=>delhiem()));
                  },
                  child: Container(
                    width: 500,
                    height: 170,
