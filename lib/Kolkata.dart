  ...
  Widget build(BuildContext context)
   {
    ...
    return  Scaffold(backgroundColor: Colors.grey,
      appBar: AppBar(title: Text('KOLKATA'),   backgroundColor: Colors.green, centerTitle: true,   ),
      ...
      children: <Widget>[Text(''),
        ...
        child: Container(
          ...
          child:InkWell(
            ...
            onTap: () {
              Navigator.push(context,MaterialPageRoute(builder: (context) => kolkataknow()));
            },
            child: Container(
              width: 500,
              height: 170,
        ...
        Card(
          child: Container(
            ...
            child:InkWell(
              splashColor: Colors.grey.withAlpha(30),
              onTap: () {
                Navigator.push(context,MaterialPageRoute(builder: (context) => checklistkol2()));
              },
              child: Container(
                width: 500,
                height: 170,
        ...
        Card(
          child: Container(
            ...
            child:InkWell(
              splashColor: Colors.grey.withAlpha(30),
              onTap: () {
                Navigator.push(context,MaterialPageRoute(builder: (context) => kolkataem()));
              },
              child: Container(
                width: 500,
                height: 170,
        ...
        Card(
          child: Container(
            ...
            child:InkWell(
              splashColor: Colors.grey.withAlpha(30),
              onTap: () {
                Navigator.push(context,MaterialPageRoute(builder: (context) => kolkatatrans()));
              },
              child: Container(
                width: 500,
                height: 170,
