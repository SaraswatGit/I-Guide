...
import 'package:myownapp/mumbaithings.dart';
import 'mumbaifoods.dart';
...
class  checklistmum  extends StatelessWidget
{
  @override
        ...
        child:Column(
          children: <Widget>[Text(''),
            ...
            Card(
              ...
              child:InkWell(
                onTap:(){
                  Navigator.push(context,MaterialPageRoute(builder: (context)=>mumbaifoods()));
            ...
            Card(
              ...
              child:InkWell(
                onTap:(){
                  Navigator.push(context,MaterialPageRoute(builder: (context)=>mumbaithings()));
