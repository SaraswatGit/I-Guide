...
import 'package:myownapp/punethings.dart';
import 'punefoods.dart';
...
class  checklistpun  extends StatelessWidget
{
  @override
        ...
        child:Column(
          children: <Widget>[Text(''),
            ...
            Card(
              ...
              child:InkWell(
                onTap:(){
                  Navigator.push(context,MaterialPageRoute(builder: (context)=>punefoods()));
            ...
            Card(
              ...
              child:InkWell(
                onTap:(){
                  Navigator.push(context,MaterialPageRoute(builder: (context)=>punethings()));
